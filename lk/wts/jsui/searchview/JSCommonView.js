...
function JSCommonView(jscontroller){
	this.type = "JSCommonView" ;
	this.jscontroller = jscontroller ;
	this.viewDiv = null ;
}

JSCommonView.prototype.setData=function(xmldom){
	this.xmldom = xmldom ;
}


JSCommonView.prototype.getView=function(){
...
JSCommonView.prototype.selectDataRaw=function(){
