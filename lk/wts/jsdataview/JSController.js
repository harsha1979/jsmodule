...
function JSController(id,service,querystring,range,selectedEvent,tableHeadersColl,isViewHeader,key,method){
	this.type = "JSController" ;
	this.id = id ;
...
JSController.prototype.init=function(){
	this.jsdata = new JSData(this);
	this.jsview = new JSView(this);
...
JSController.prototype.setRequestCondition=function(names,values,comparisons,criterias){

}
JSController.prototype.requestXML=function(name,value,comparison){
	
}

JSController.prototype.drawView=function(){
	//alert(dd.dd);
...
JSController.prototype.prevData=function(){
...
JSController.prototype.nextData=function(){
	//alert("nextData");
	//alert(dd.dd);
...
JSController.prototype.selectData=function(dataArray){
...
JSController.prototype.clear=function(){
	//alert(sss.ss);
...
JSController.prototype.test=function(){
...
JSController.prototype.setDataTableStyle=function(dataTableStyle){
	this.dataTableStyle = dataTableStyle;
}
JSController.prototype.setDataRowStyle=function(dataRowStyle){
	this.dataRowStyle = dataRowStyle;
}
JSController.prototype.setDataMouseOverRowStyle=function(dataMouseOverRowStyle){
	this.dataMouseOverRowStyle = dataMouseOverRowStyle;
}

JSController.prototype.setControllerTableStyle=function(controllerTableStyle){
	this.controllerTableStyle = controllerTableStyle;
}
JSController.prototype.setControllerCellStylePrev=function(controllerCellStylePrev){
	this.controllerCellStylePrev = controllerCellStylePrev;
}
JSController.prototype.setControllerCellStyleNext=function(controllerCellStyleNext){
	this.controllerCellStyleNext = controllerCellStyleNext;
}
JSController.prototype.setControllerCellStyleClose=function(controllerCellStyleClose){
	this.controllerCellStyleClose = controllerCellStyleClose;
}

JSController.prototype.setControllerMouseOverPrevStyle=function(controllerMouseOverPrevStyle){
	this.controllerMouseOverPrevStyle = controllerMouseOverPrevStyle;
}
JSController.prototype.setControllerMouseOverNextStyle=function(controllerMouseOverNextStyle){
	this.controllerMouseOverNextStyle = controllerMouseOverNextStyle;
}
JSController.prototype.setControllerMouseOverCloseStyle=function(controllerMouseOverCloseStyle){
	this.controllerMouseOverCloseStyle = controllerMouseOverCloseStyle;
}
JSController.prototype.setControllerHeaderStyle=function(controllerHeaderStyle){
	this.controllerHeaderStyle = controllerHeaderStyle ;
}
